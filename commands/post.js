module.exports = {
	...
	async execute(message, args) {
		...
		const backup = message.client.guilds.cache.get('608709068776931328').channels.cache.get('608710595650387981');
		const join = await backup.messages.fetch('610725013300969491');
...
// const bLanding = client.channels.cache.get('608710595650387981');
